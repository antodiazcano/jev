...
For every coding task, invoke and follow `$ponytail` at `full` intensity before making implementation decisions. Keep it active throughout the task unless the user says "stop ponytail" or "normal mode".
